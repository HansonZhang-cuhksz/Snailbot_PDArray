...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  */
    ...
    PA3     ------> ADC1_IN4
    */
    GPIO_InitStruct.Pin = ADC_96_111_Pin|ADC_16_31_Pin;
  ...
  */
    ...
    PB11     ------> ADC2_IN14
    */
    GPIO_InitStruct.Pin = ADC_0_15_Pin|ADC_48_63_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = ADC_32_47_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(ADC_32_47_GPIO_Port, &GPIO_InitStruct);
  ...
  */
    ...
    PB13     ------> ADC3_IN5
    */
    GPIO_InitStruct.Pin = ADC_112_127_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(ADC_112_127_GPIO_Port, &GPIO_InitStruct);
  ...
  */
    ...
    PB12     ------> ADC4_IN3
    */
    GPIO_InitStruct.Pin = ADC_64_79_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(ADC_64_79_GPIO_Port, &GPIO_InitStruct);
  ...
  */
    ...
    PA8     ------> ADC5_IN1
    */
    GPIO_InitStruct.Pin = ADC_80_95_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(ADC_80_95_GPIO_Port, &GPIO_InitStruct);
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PA3     ------> ADC1_IN4
    */
    HAL_GPIO_DeInit(GPIOA, ADC_96_111_Pin|ADC_16_31_Pin);
  ...
  /* USER CODE END ADC2_MspDeInit 0 */
    ...
    PB11     ------> ADC2_IN14
    */
    HAL_GPIO_DeInit(GPIOA, ADC_0_15_Pin|ADC_48_63_Pin);

    HAL_GPIO_DeInit(ADC_32_47_GPIO_Port, ADC_32_47_Pin);
  ...
  /* USER CODE END ADC3_MspDeInit 0 */
    ...
    PB13     ------> ADC3_IN5
    */
    HAL_GPIO_DeInit(ADC_112_127_GPIO_Port, ADC_112_127_Pin);
  ...
  /* USER CODE END ADC4_MspDeInit 0 */
    ...
    PB12     ------> ADC4_IN3
    */
    HAL_GPIO_DeInit(ADC_64_79_GPIO_Port, ADC_64_79_Pin);
  ...
  /* USER CODE END ADC5_MspDeInit 0 */
    ...
    PA8     ------> ADC5_IN1
    */
    HAL_GPIO_DeInit(ADC_80_95_GPIO_Port, ADC_80_95_Pin);
